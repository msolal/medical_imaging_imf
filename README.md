...
# Supported values are: cpu, cu126, cu124, cu118
...
<details>
<summary><b>Train on CPU, GPU, and TPU</b></summary>
...
> This should be achievable with either [the right lightning trainer flags](https://lightning.ai/docs/pytorch/latest/clouds/cluster_advanced.html#run-on-a-slurm-managed-cluster) or simple config using [Submitit launcher for Hydra](https://hydra.cc/docs/plugins/submitit_launcher). Example is not yet implemented in this template.
...
Compared to `conda`, it's much faster and easier to use.
